...
def select_best_squad(min_budget, max_budget, formation, scoring_strategy, clubboost, nationboost,currently,nations=[],clubs=[], nogens=200,popul=800,csv_path="final_player_data.csv"):
    SEED = 1
    random.seed(SEED)
    np.random.seed(SEED)
