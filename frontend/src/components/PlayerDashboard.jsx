...
const PlayerDashboard = ({ player }) => {
    ...
    return (
        ...
        >
            {/* Player Info Section */}
            <motion.div 
                className="bg-black rounded-lg p-4 shadow-md col-span-1"
            ...
            >
                ...
                <motion.div 
                    className="mt-2 bg-blue-900/50 p-3 rounded"
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
            ...
            {shouldShowDefensiveStats && (
                <motion.div 
                    className="bg-black rounded-lg p-4 shadow-md col-span-1 md:col-span-3 lg:col-span-1"
                    variants={cardVariants}
                >
