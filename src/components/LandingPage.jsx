...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-br from-blue-800 to-purple-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 lg:grid lg:grid-cols-2 lg:gap-16">
          <div className="mt-10 lg:mt-0">
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl">
              Squadify: AI-Driven Football Squad Optimization
            </h1>
          ...
          <div className="hidden lg:block relative">
            <img 
              ...
              className="w-400 h-400 rounded-full shadow-black-lg"
            />
          </div>
        </div>
      </div>
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <p>&copy; 2024 Squadify. All rights reserved.</p>
